...
namespace PixVerse
{
    public partial class PixVerseClient
    {
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement s_CreateTransitionVideoSecurityRequirement0 =
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement[] s_CreateTransitionVideoSecurityRequirements =
            new global::PixVerse.EndPointSecurityRequirement[]
            {                s_CreateTransitionVideoSecurityRequirement0,
            };
        partial void PrepareCreateTransitionVideoArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::PixVerse.TransitionVideoRequest request);
        partial void PrepareCreateTransitionVideoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::PixVerse.TransitionVideoRequest request);
        partial void ProcessCreateTransitionVideoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTransitionVideoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.VideoGenerationApiResponse> CreateTransitionVideoAsync(

            global::PixVerse.TransitionVideoRequest request,
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTransitionVideoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PixVerse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PixVerse.AutoSDKHttpResponse<global::PixVerse.VideoGenerationApiResponse>> CreateTransitionVideoAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTransitionVideoArguments(
            ...
            var __authorizations = global::PixVerse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTransitionVideoSecurityRequirements,
                operationName: "CreateTransitionVideoAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PixVerse.PathBuilder(
                                path: "/video/transition/generate",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTransitionVideoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PixVerse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTransitionVideo",
                                methodName: "CreateTransitionVideoAsync",
                                pathTemplate: "\"/video/transition/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTransitionVideoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTransitionVideoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.VideoGenerationApiResponse> CreateTransitionVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PixVerse.TransitionVideoRequest
            {
                FirstFrameImgId = firstFrameImgId,
                LastFrameImgId = lastFrameImgId,
                Prompt = prompt,
                Model = model,
                Duration = duration,
                Quality = quality,
            ...
            return await CreateTransitionVideoAsync(
                request: __request,
                requestOptions: requestOptions,

...
namespace PixVerse
{
    public partial class PixVerseClient
    {
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement s_CreateImageTemplateSecurityRequirement0 =
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement[] s_CreateImageTemplateSecurityRequirements =
            new global::PixVerse.EndPointSecurityRequirement[]
            {                s_CreateImageTemplateSecurityRequirement0,
            };
        partial void PrepareCreateImageTemplateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::PixVerse.ImageTemplateRequest request);
        partial void PrepareCreateImageTemplateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::PixVerse.ImageTemplateRequest request);
        partial void ProcessCreateImageTemplateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateImageTemplateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.ImageGenerationApiResponse> CreateImageTemplateAsync(

            global::PixVerse.ImageTemplateRequest request,
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateImageTemplateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PixVerse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PixVerse.AutoSDKHttpResponse<global::PixVerse.ImageGenerationApiResponse>> CreateImageTemplateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateImageTemplateArguments(
            ...
            var __authorizations = global::PixVerse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateImageTemplateSecurityRequirements,
                operationName: "CreateImageTemplateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateImageTemplateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PixVerse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateImageTemplateAsync",
                                pathTemplate: "\"/image/template/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateImageTemplateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateImageTemplateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PixVerse.ImageGenerationApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PixVerse.AutoSDKHttpResponse<global::PixVerse.ImageGenerationApiResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PixVerse.ImageGenerationApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.ImageGenerationApiResponse> CreateImageTemplateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PixVerse.ImageTemplateRequest
            {
            ...
            return await CreateImageTemplateAsync(
                request: __request,
                requestOptions: requestOptions,

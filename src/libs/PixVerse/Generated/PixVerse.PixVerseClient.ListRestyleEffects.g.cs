...
namespace PixVerse
{
    public partial class PixVerseClient
    {
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement s_ListRestyleEffectsSecurityRequirement0 =
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement[] s_ListRestyleEffectsSecurityRequirements =
            new global::PixVerse.EndPointSecurityRequirement[]
            {                s_ListRestyleEffectsSecurityRequirement0,
            };
        partial void PrepareListRestyleEffectsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareListRestyleEffectsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessListRestyleEffectsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListRestyleEffectsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.RestyleListApiResponse> ListRestyleEffectsAsync(
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListRestyleEffectsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PixVerse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PixVerse.AutoSDKHttpResponse<global::PixVerse.RestyleListApiResponse>> ListRestyleEffectsAsResponseAsync(
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListRestyleEffectsArguments(
                httpClient: HttpClient);


            var __authorizations = global::PixVerse.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ListRestyleEffectsSecurityRequirements,
                operationName: "ListRestyleEffectsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListRestyleEffectsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PixVerse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListRestyleEffects",
                                methodName: "ListRestyleEffectsAsync",
                                pathTemplate: "\"/video/restyle/list\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListRestyleEffectsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRestyleEffectsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PixVerse.RestyleListApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PixVerse.AutoSDKHttpResponse<global::PixVerse.RestyleListApiResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PixVerse.RestyleListApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

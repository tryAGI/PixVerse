...
namespace PixVerse
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::PixVerse.AutoSDKRetryOptions Retry { get; set; } = new global::PixVerse.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::PixVerse.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::PixVerse.IAutoSDKHook>();
        ...
        public global::PixVerse.AutoSDKClientOptions AddHook(
            global::PixVerse.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::PixVerse.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::PixVerse.AutoSDKClientOptions UseAuthorizationProvider(
            global::PixVerse.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::PixVerse.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::PixVerse.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::PixVerse.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::PixVerse.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::PixVerse.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::PixVerse.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::PixVerse.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::PixVerse.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::PixVerse.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::PixVerse.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::PixVerse.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::PixVerse.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::PixVerse.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::PixVerse.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::PixVerse.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::PixVerse.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::PixVerse.AutoSDKClientOptions clientOptions,
            global::PixVerse.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::PixVerse.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::PixVerse.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::PixVerse.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::PixVerse.AutoSDKClientOptions clientOptions,
            global::System.Func<global::PixVerse.IAutoSDKHook, global::PixVerse.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::PixVerse.AutoSDKHookContext context)
        {

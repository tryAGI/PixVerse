...
namespace PixVerse
{
    public partial class PixVerseClient
    {
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement s_CreateVideoMaskSelectionSecurityRequirement0 =
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement[] s_CreateVideoMaskSelectionSecurityRequirements =
            new global::PixVerse.EndPointSecurityRequirement[]
            {                s_CreateVideoMaskSelectionSecurityRequirement0,
            };
        partial void PrepareCreateVideoMaskSelectionArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::PixVerse.MaskSelectionRequest request);
        partial void PrepareCreateVideoMaskSelectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::PixVerse.MaskSelectionRequest request);
        partial void ProcessCreateVideoMaskSelectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVideoMaskSelectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.MaskSelectionApiResponse> CreateVideoMaskSelectionAsync(

            global::PixVerse.MaskSelectionRequest request,
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVideoMaskSelectionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PixVerse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PixVerse.AutoSDKHttpResponse<global::PixVerse.MaskSelectionApiResponse>> CreateVideoMaskSelectionAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVideoMaskSelectionArguments(
            ...
            var __authorizations = global::PixVerse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVideoMaskSelectionSecurityRequirements,
                operationName: "CreateVideoMaskSelectionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVideoMaskSelectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PixVerse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVideoMaskSelection",
                                methodName: "CreateVideoMaskSelectionAsync",
                                pathTemplate: "\"/video/mask/selection\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVideoMaskSelectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVideoMaskSelectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PixVerse.MaskSelectionApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PixVerse.AutoSDKHttpResponse<global::PixVerse.MaskSelectionApiResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PixVerse.MaskSelectionApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.MaskSelectionApiResponse> CreateVideoMaskSelectionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PixVerse.MaskSelectionRequest
            {
            ...
            return await CreateVideoMaskSelectionAsync(
                request: __request,
                requestOptions: requestOptions,

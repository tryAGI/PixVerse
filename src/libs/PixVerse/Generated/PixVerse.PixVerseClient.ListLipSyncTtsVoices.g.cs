...
namespace PixVerse
{
    public partial class PixVerseClient
    {
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement s_ListLipSyncTtsVoicesSecurityRequirement0 =
        ...
        private static readonly global::PixVerse.EndPointSecurityRequirement[] s_ListLipSyncTtsVoicesSecurityRequirements =
            new global::PixVerse.EndPointSecurityRequirement[]
            {                s_ListLipSyncTtsVoicesSecurityRequirement0,
            };
        partial void PrepareListLipSyncTtsVoicesArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareListLipSyncTtsVoicesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessListLipSyncTtsVoicesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListLipSyncTtsVoicesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PixVerse.LipSyncTtsListApiResponse> ListLipSyncTtsVoicesAsync(
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListLipSyncTtsVoicesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PixVerse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PixVerse.AutoSDKHttpResponse<global::PixVerse.LipSyncTtsListApiResponse>> ListLipSyncTtsVoicesAsResponseAsync(
            global::PixVerse.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListLipSyncTtsVoicesArguments(
                httpClient: HttpClient);


            var __authorizations = global::PixVerse.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ListLipSyncTtsVoicesSecurityRequirements,
                operationName: "ListLipSyncTtsVoicesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListLipSyncTtsVoicesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PixVerse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListLipSyncTtsVoices",
                                methodName: "ListLipSyncTtsVoicesAsync",
                                pathTemplate: "\"/video/lip_sync/tts_list\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListLipSyncTtsVoicesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PixVerse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListLipSyncTtsVoicesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PixVerse.LipSyncTtsListApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PixVerse.AutoSDKHttpResponse<global::PixVerse.LipSyncTtsListApiResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PixVerse.LipSyncTtsListApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
